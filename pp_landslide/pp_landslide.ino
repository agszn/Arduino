...
// Sensor values
int xState, yState, zState, soilMoisture, vibrationState, rainDetected;
float temperature;
...
void loop() {
  ...
  // Check conditions
  if (xState == 1 && yState == 1 && zState == 1 && temperature > 35 && soilMoisture < 1000 && vibrationState == 1 && rainDetected) {
